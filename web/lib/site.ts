...
export const products: Record<string, Product> = {
  ...
  'bouquet-blush-lily-daisy': {
    ...
    metaDescription: 'Handmade blush pink lily with white daisy florets and fern greenery in soft pink wrapping with net lace bow. ₹599, made to order.',
  ...
  'lotus-asaan-red': {
    ...
    priceValue: 399,
    badge: '20% OFF',
    metaTitle: 'Lotus Asaan (Vibrant Red) — handmade lotus seat for Ganpati',
    metaDescription: 'Handmade velvet craft-wire lotus asaan in vibrant red petals with pearl-tipped edges for your Ganpati idol. ₹399 (MRP ₹499), made to order.',
    priceRange: { low: 399, high: 399 },
    summary: 'A radiant handcrafted lotus asaan featuring vibrant red velvet petals adorned with lustrous pearls, a textured golden-yellow center, and emerald green base leaves — a magnificent sacred throne for Ganpati Bappa.',
    images: [
      '/assets/lotus-asaan-red-chalkboard.jpeg',
      '/assets/lotus-asaan-red.jpeg',
    ],
